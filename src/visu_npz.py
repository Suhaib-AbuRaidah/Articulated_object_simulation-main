...
data_path = os.path.expanduser("~/Articulated_object_simulation-main/data/dataset/train/samples")
...
for index in range(len(npz_files)):
    ...
    pcd_end.translate((1.5, 0, 0))  # Translate the second point cloud to the right for better visualization
